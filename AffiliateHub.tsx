...
import { platforms } from './data/connections';
import { LOCAL_STORAGE_KEY } from './data/connections';
        ...
        for (const p of affiliatePlatforms) {
            try {
                ...
                if (isSocial) {
                    ...
                    const hasValidToken = platformConnection && Object.values(platformConnection.credentials).some(val => val && val.length > 10);
                    if (!hasValidToken) {
