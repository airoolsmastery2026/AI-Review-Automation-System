...
const platforms: Platform[] = [
    // Social Media
    { id: "youtube", nameKey: "connections.youtube", docsUrl: 'https://console.cloud.google.com/apis/credentials', neonColor: '#FF0000', categoryKey: 'connections.category_social', guideKey: "connections.guide_youtube", credentials: [{ id: 'clientId', labelKey: 'connections.clientId', placeholderKey: 'connections.clientIdPlaceholder', type: 'text' }, { id: 'clientSecret', labelKey: 'connections.clientSecret', placeholderKey: 'connections.clientSecretPlaceholder', type: 'password' }] },
    { id: "tiktok", nameKey: "connections.tiktok", docsUrl: 'https://developers.tiktok.com/doc/login-kit-web/', neonColor: '#25F4EE', categoryKey: 'connections.category_social', guideKey: "connections.guide_tiktok", credentials: [{ id: 'clientKey', labelKey: 'connections.clientKey', placeholderKey: 'connections.clientKeyPlaceholder', type: 'text' }, { id: 'clientSecret', labelKey: 'connections.clientSecret', placeholderKey: 'connections.clientSecretPlaceholder', type: 'password' }] },
    { id: "facebook", nameKey: "connections.facebook", docsUrl: 'https://developers.facebook.com/docs/graph-api/get-started', neonColor: '#1877F2', categoryKey: 'connections.category_social', guideKey: "connections.guide_facebook", credentials: [{ id: 'appId', labelKey: 'connections.appId', placeholderKey: 'connections.appIdPlaceholder', type: 'text' }, { id: 'appSecret', labelKey: 'connections.appSecret', placeholderKey: 'connections.appSecretPlaceholder', type: 'password' }] },
    { id: "instagram", nameKey: "connections.instagram", docsUrl: 'https://developers.facebook.com/docs/instagram-basic-display-api/getting-started', neonColor: '#d6249f', categoryKey: 'connections.category_social', guideKey: "connections.guide_instagram", credentials: [{ id: 'accessToken', labelKey: 'connections.accessToken', placeholderKey: 'connections.accessTokenPlaceholder', type: 'password' }] },
    { id: "x", nameKey: "connections.x", docsUrl: 'https://developer.twitter.com/en/docs/authentication/oauth-2-0', neonColor: '#FFFFFF', categoryKey: 'connections.category_social', guideKey: "connections.guide_x", credentials: [{ id: 'clientId', labelKey: 'connections.clientId', placeholderKey: 'connections.clientIdPlaceholder', type: 'text' }, { id: 'clientSecret', labelKey: 'connections.clientSecret', placeholderKey: 'connections.clientSecretPlaceholder', type: 'password' }] },
    { id: "pinterest", nameKey: "connections.pinterest", docsUrl: 'https://developers.pinterest.com/docs/getting-started/authentication/', neonColor: '#E60023', categoryKey: 'connections.category_social', guideKey: "connections.guide_pinterest", credentials: [{ id: 'appId', labelKey: 'connections.appId', placeholderKey: 'connections.appIdPlaceholder', type: 'text' }, { id: 'appSecret', labelKey: 'connections.appSecret', placeholderKey: 'connections.appSecretPlaceholder', type: 'password' }] },
    { id: "telegram", nameKey: "connections.telegram", docsUrl: 'https://core.telegram.org/bots#6-botfather', neonColor: '#2AABEE', categoryKey: 'connections.category_social', guideKey: "connections.guide_telegram", credentials: [{ id: 'botToken', labelKey: 'connections.botToken', placeholderKey: 'connections.botTokenPlaceholder', type: 'password' }] },
    { id: "zalo", nameKey: "connections.zalo", docsUrl: 'https://developers.zalo.me/docs/api/official-account-api/xac-thuc-va-uy-quyen/official-account-access-token-post-4307', neonColor: '#0068FF', categoryKey: 'connections.category_social', guideKey: "connections.guide_zalo", credentials: [{ id: 'appId', labelKey: 'connections.appId', placeholderKey: 'connections.appIdPlaceholder', type: 'text' }, { id: 'secretKey', labelKey: 'connections.secretKey', placeholderKey: 'connections.secretKeyPlaceholder', type: 'password' }] },

    // Affiliate Global
    { id: "clickbank", nameKey: "connections.clickbank", docsUrl: 'https://support.clickbank.com/hc/en-us/articles/115015505708', neonColor: '#F7941D', categoryKey: 'connections.category_affiliate_global', guideKey: "connections.guide_default", credentials: [{ id: 'apiKey', labelKey: 'connections.apiKey', placeholderKey: 'connections.apiKeyPlaceholder', type: 'password' }] },
    { id: "amazon", nameKey: "connections.amazon", docsUrl: 'https://affiliate-program.amazon.com/help/topic/t100', neonColor: '#FF9900', categoryKey: 'connections.category_affiliate_global', guideKey: "connections.guide_default", credentials: [{ id: 'accessKey', labelKey: 'connections.accessKey', placeholderKey: 'connections.accessKeyPlaceholder', type: 'text' }, { id: 'secretKey', labelKey: 'connections.secretKey', placeholderKey: 'connections.secretKeyPlaceholder', type: 'password' }] },
    { id: "shopify", nameKey: "connections.shopify", docsUrl: 'https://shopify.dev/docs/apps/auth/oauth/getting-started', neonColor: '#7AB55C', categoryKey: 'connections.category_affiliate_global', guideKey: "connections.guide_default", credentials: [{ id: 'apiKey', labelKey: 'connections.apiKey', placeholderKey: 'connections.apiKeyPlaceholder', type: 'password' }, { id: 'apiSecret', labelKey: 'connections.apiSecret', placeholderKey: 'connections.apiSecretPlaceholder', type: 'password' }] },
    { id: "impact", nameKey: "connections.impact", docsUrl: 'https://developer.impact.com/impact-api-started-guide/', neonColor: '#F05D38', categoryKey: 'connections.category_affiliate_global', guideKey: "connections.guide_default", credentials: [{ id: 'accountSid', labelKey: 'connections.accountSid', placeholderKey: 'connections.accountSidPlaceholder', type: 'text' }, { id: 'authToken', labelKey: 'connections.authToken', placeholderKey: 'connections.authTokenPlaceholder', type: 'password' }] },
    { id: "partnerstack", nameKey: "connections.partnerstack", docsUrl: 'https://developers.partnerstack.com/reference/introduction', neonColor: '#4B40EE', categoryKey: 'connections.category_affiliate_global', guideKey: "connections.guide_default", credentials: [{ id: 'publicKey', labelKey: 'connections.publicKey', placeholderKey: 'connections.publicKeyPlaceholder', type: 'text' }, { id: 'secretKey', labelKey: 'connections.secretKey', placeholderKey: 'connections.secretKeyPlaceholder', type: 'password' }] },
    { id: "digistore24", nameKey: "connections.digistore24", docsUrl: 'https://dev.digistore24.com/', neonColor: '#007BFF', categoryKey: 'connections.category_affiliate_global', guideKey: "connections.guide_default", credentials: [{ id: 'apiKey', labelKey: 'connections.apiKey', placeholderKey: 'connections.apiKeyPlaceholder', type: 'password' }] },
    
    // Affiliate VN
    { id: "lazada", nameKey: "connections.lazada", docsUrl: 'https://open.lazada.com/doc/doc.htm?spm=a2o9m.11193494.0.0.1f733535j2q0zP&source=search&docId=108298&treeId=1', neonColor: '#0F146D', categoryKey: 'connections.category_affiliate_vn', guideKey: "connections.guide_default", credentials: [{ id: 'appKey', labelKey: 'connections.appKey', placeholderKey: 'connections.appKeyPlaceholder', type: 'text' }, { id: 'appSecret', labelKey: 'connections.appSecret', placeholderKey: 'connections.appSecretPlaceholder', type: 'password' }] },
    { id: "shopee", nameKey: "connections.shopee", docsUrl: 'https://open.shopee.com/documents/v2/v2.1/introduction?module=83&type=2', neonColor: '#EE4D2D', categoryKey: 'connections.category_affiliate_vn', guideKey: "connections.guide_default", credentials: [{ id: 'partnerId', labelKey: 'connections.partnerId', placeholderKey: 'connections.partnerIdPlaceholder', type: 'text' }, { id: 'apiKey', labelKey: 'connections.apiKey', placeholderKey: 'connections.apiKeyPlaceholder', type: 'password' }] },
    { id: "tiki", nameKey: "connections.tiki", docsUrl: 'https://open.tiki.vn/', neonColor: '#1A94FF', categoryKey: 'connections.category_affiliate_vn', guideKey: "connections.guide_default", credentials: [{ id: 'clientId', labelKey: 'connections.clientId', placeholderKey: 'connections.clientIdPlaceholder', type: 'text' }, { id: 'clientSecret', labelKey: 'connections.clientSecret', placeholderKey: 'connections.clientSecretPlaceholder', type: 'password' }] },
];
